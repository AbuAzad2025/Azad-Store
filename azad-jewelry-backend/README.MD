# Azad Smart Systems – Full Stack eCommerce Web Application + Admin Panel


Azad Smart Systems is a powerful and modern full stack eCommerce web application built using Next.js, Express.js, MongoDB with Mongoose, Redux Toolkit, RTK Query, Stripe payment method, Bootstrap 5, and Sass. It includes a feature-rich admin panel for easy management and control of your online store.
...
Ensure the following backend dependencies are installed:
...
- **Utilities:**
  - `cloudinary`: Image management and upload.
...
## Thank You for Choosing Azad Smart Systems!

We hope you find Azad Smart Systems to be a powerful and effective solution for your eCommerce needs. If you encounter any issues or have any questions, please reach out via this repository.
