# Azad Advanced Systems – Full Stack eCommerce Web Application + Admin Panel


![Azad Advanced Systems Logo](public/assets/img/logo/azad-logo.png)

Azad Advanced Systems is a powerful and modern full stack eCommerce web application built using Next.js, Express.js, MongoDB with Mongoose, Redux Toolkit, RTK Query, Stripe payment method, Bootstrap 5, and Sass. It includes a feature-rich admin panel for easy management and control of your online store.
...
- **Authentication:** Includes features for Google login, user registration, email verification, forgot password, reset password, and profile updates.
...
- **Responsive Layout Design:** Fully responsive across all devices, providing a seamless experience for your customers.
...
- **Flexible and Multi-Purpose:** Versatile and can be adapted to various eCommerce niches.
...
- **All E-commerce Features and Apps Included:** Provides a comprehensive eCommerce solution with all the essential features and apps needed for a successful online store.
...
This project relies on several key libraries. Ensure these are installed via `npm install`:

- **UI & Interaction:**
  - `sweetalert2`: For admin confirmation modals.
  - `react-toastify`: For toast notifications.
  - `recharts`: For admin dashboard charts and reports.
  - `swiper` & `slick-carousel`: For sliders.

- **Data & State Management:**
  - `@reduxjs/toolkit` & `react-redux`: Global state management.
  - `js-cookie`: Handling authentication tokens.
...
## Thank You for Choosing Azad Advanced Systems!

We hope you find Azad Advanced Systems to be a powerful and effective solution for your eCommerce needs. Should you encounter

 any issues or have any questions, please contact your support team. Happy selling!
