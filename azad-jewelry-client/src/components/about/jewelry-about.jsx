            ...
            <div className="col-xl-7 col-lg-6">
              <div className="tp-about-wrapper pl-80 pt-75 pr-60">
                <div className="tp-section-title-wrapper-4 mb-50">
                  <span className="tp-section-title-pre-4">{t("jewelryAboutSubtitle")}</span>
                  <h3 className="tp-section-title-4 fz-50">{t("jewelryAboutTitle")}</h3>
                </div>
                <div className="tp-about-content pl-120">
                  <p>
                    {t("jewelryAboutDescLine1")} <br /> {t("jewelryAboutDescLine2")}
                  </p>

                  <div className="tp-about-btn">
                    <Link href="/contact" className="tp-btn">
                      {t("contactUs")}{" "}<ArrowRightLong />
                    </Link>
                  </div>
                </div>
              </div>
