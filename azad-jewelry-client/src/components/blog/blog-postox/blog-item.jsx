        ...
        {item.slider && (
          <Swiper {...slider_setting} modules={[Navigation, Autoplay]} className="tp-postbox-thumb tp-postbox-slider swiper-container w-img p-relative">
            ...
            <div className="tp-postbox-nav">
              <button type="button" className="tp-postbox-slider-button-next" aria-label={t("next")} title={t("next")}>
                <i className="fa-solid fa-arrow-right"></i>
              </button>
              <button type="button" className="tp-postbox-slider-button-prev" aria-label={t("previous")} title={t("previous")}>
