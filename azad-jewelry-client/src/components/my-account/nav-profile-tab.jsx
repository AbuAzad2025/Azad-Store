          ...
          <div className="col-md-6">
            <div className="profile__main-inner d-flex flex-wrap align-items-center">
              <div className="profile__main-content">
                <h4 className="profile__main-title">{t("helloUser", { name: user?.name || "" })}</h4>
              </div>
            </div>
          </div>
          <div className="col-md-6">
        ...
        <div className="row gx-3">
          <div className="col-md-3 col-sm-6">
            <div className="profile__main-info-item">
              ...
              <h4 className="profile__main-info-title">{t("dashboardTotalOrders")}</h4>
            </div>
          </div>
          <div className="col-md-3 col-sm-6">
            <div className="profile__main-info-item">
              ...
              <h4 className="profile__main-info-title">{t("dashboardPendingOrders")}</h4>
            </div>
          </div>
          <div className="col-md-3 col-sm-6">
            <div className="profile__main-info-item">
              ...
              <h4 className="profile__main-info-title">{t("dashboardProcessingOrders")}</h4>
            </div>
          </div>
          <div className="col-md-3 col-sm-6">
            <div className="profile__main-info-item">
              ...
              <h4 className="profile__main-info-title">{t("dashboardCompletedOrders")}</h4>
            </div>
          </div>
        </div>
      </div>
