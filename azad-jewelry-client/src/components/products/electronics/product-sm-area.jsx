  ...
  if (!isLoading && !isError && products?.data?.length > 0) {
    ...
    content = <div className="row">
      <div className="col-xl-4 col-md-6">
        <div className="tp-product-sm-list mb-50">
          <div className="tp-section-title-wrapper mb-40">
            <h3 className="tp-section-title tp-section-title-sm">{t("discountProducts")}
              <ShapeLineSm />
            </h3>
          </div>
      ...
      <div className="col-xl-4 col-md-6">
        <div className="tp-product-sm-list mb-50">
          <div className="tp-section-title-wrapper mb-40">
            <h3 className="tp-section-title tp-section-title-sm">{t("featuredProducts")}
              <ShapeLineSm />
            </h3>
          </div>
      ...
      <div className="col-xl-4 col-md-6">
        <div className="tp-product-sm-list mb-50">
          <div className="tp-section-title-wrapper mb-40">
            <h3 className="tp-section-title tp-section-title-sm">{t("sellingProducts")}
              <ShapeLineSm />
            </h3>
          </div>
