            ...
            <div className="col-xl-12">
              <div className="tp-section-title-wrapper-2 mb-50">
                <span className="tp-section-title-pre-2">
                  {t("bestSellerThisWeek")}
                  <TextShapeLine />
                </span>
                <h3 className="tp-section-title-2">{t("weeksFeatured")}</h3>
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-seller-more text-center mt-10">
                <Link href="/shop" className="tp-btn tp-btn-border tp-btn-border-sm">{t("shopAllProducts")}</Link>
              </div>
            </div>
          </div>
        </div>
