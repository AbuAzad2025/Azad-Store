...
const Footer = ({ style_2 = false, style_3 = false, primary_style = false }) => {
  ...
  return (
    <footer>
      <div className={`tp-footer-area ${primary_style ? 'tp-footer-style-2' : ''} ${style_2 ? 'tp-footer-style-2' : style_3 ? 'tp-footer-style-2 tp-footer-style-3' : ''}`}
            ...
            <div className="row">
              ...
              <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <div className="tp-footer-widget footer-col-4 mb-50">
                  <h4 className="tp-footer-widget-title">{t("contactUs")}</h4>
                  <div className="tp-footer-widget-content">
