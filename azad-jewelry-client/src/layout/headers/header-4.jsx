...
const HeaderFour = () => {
  ...
  return (
    <>
      <header>
        <div id="header-sticky" className={`tp-header-area tp-header tp-header-sticky has-dark-logo tp-header-height ${sticky ? 'header-sticky' : ''}`}>
            ...
            <div className="container-fluid">
              <div className="row align-items-center">
                ...
                <div className="col-xl-8 col-lg-8 d-none d-lg-block">
                  <div className="main-menu menu-style-2 p-relative">
                ...
                <div className="col-xl-2 col-lg-2 col-6">
                  <div className="tp-header-action d-flex align-items-center justify-content-end gap-2">

                    <div className="tp-header-action-item d-none d-sm-block">
                      <button onClick={() => setIsSearchOpen(true)} type="button" className="tp-header-action-btn tp-search-open-btn" aria-label={t("search")} title={t("search")}>
                        <Search />
                      </button>
                    </div>
                    <div className="tp-header-action-item d-none d-sm-block">
                      <button onClick={toggleLanguage} type="button" className="tp-header-action-btn tp-header-lang-btn" title={t("language")}>
